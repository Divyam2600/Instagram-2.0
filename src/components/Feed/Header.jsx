    ...
    <div className="flex items-center p-3">
      ...
      <Menu as="div" className="relative inline-block text-left">
        ...
        {activeUsername === username && (
          ...
          >
            <Menu.Items className="absolute right-2 mt-2 w-36 origin-top-right rounded-md border border-gray-100 border-opacity-50 bg-white shadow-md ring-1 ring-black ring-opacity-5 focus:outline-none">
              <Menu.Item>
                <Menu.Button
