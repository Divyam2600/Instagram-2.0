...
function Login() {
  ...
  return (
    <div className="grid">
      <div>
        <div className="top-grid p-5 -mb-36 ">
          <h1 className="flex justify-center w-full -mx-16">
            <img
              src="/images/logo.png"
              alt="Instagram Logo"
              className="mt-4 w-48 mb-6 "
            />
          </h1>
          ...
          <form method="POST" onSubmit={handleLogin}>
            ...
            <h1 className="flex text-center justify-center ">
              <button
                ...
                className="my-3 text-blue-900 decoration-inherit font-semibold"
              >
                Forgot Password?
              </button>
            </h1>
